...
public class ScreenApi {
    ...
    //TODO: transaction id
    public void shows_the_paid_order_with_item(String itemName) {
//       WebElement transactionId = driver.findElement(By.className("transaction-id"));
        List<WebElement> itemNameElements = driver.findElements(By.className("item-name"));

        List<String> itemNames = new ArrayList<String>();
        for (WebElement element : itemNameElements) {
            itemNames.add(element.getText());
        }
        assertTrue(itemNames.contains(itemName));
    }
