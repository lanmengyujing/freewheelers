...
public class ManageItemTable {
    ...
    public static By imageFieldFor(String name) {
        return By.xpath("//tbody/tr/td[2]/img");
    }

    public static By nameFieldFor(String name) {
        return By.xpath("//tbody/tr/td[3]/input[@value='" + name + "']");
    }

    public static By checkBoxFor(String name) {
        return By.xpath("//tbody/tr/td[3]/input[@value='" + name + "']/parent::*/parent::*/td[1]/input[2]");
    }
